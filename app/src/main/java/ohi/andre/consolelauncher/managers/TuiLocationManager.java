...
public class TuiLocationManager {
    ...
    private void register() {
        ...
        // Run location request on Main Thread to ensure Looper is available for listener callbacks if needed
        ...
        // FIX: Use Looper.getMainLooper() to ensure Handler is attached to the main thread
    ...
    private void dispose() {
        ...
        } catch (Exception e) {} // Catch receiver not registered exception

        // Remove updates on Main Thread
        new Handler(Looper.getMainLooper()).post(() -> {
            try {
                LocationManager manager = (LocationManager) context.getSystemService(Context.LOCATION_SERVICE);
